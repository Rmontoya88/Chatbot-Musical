...
#
# print(f"Mongo URI cargada: {MONGO_URI}")
#
# # ─────────────────────────────────────────────────────────────
...
# 1. Solo usas las canciones del contexto para responder.
# 2. NUNCA hagas análisis de sentimiento a menos que el usuario lo pida explícitamente.
# 3. NUNCA hagas resúmenes ni traducciones a menos que el usuario lo pida.
# 4. Si el usuario pide recomendaciones, simplemente lista canciones del contexto con una breve descripción.
# 5. Si el usuario hace una pregunta general sobre música, respóndela directamente.
# 6. No inventes canciones, artistas ni datos que no estén en el contexto.
# 7. Si el contexto no tiene información suficiente, dilo claramente.
# 8. Responde siempre en español, con tono amigable y conciso.
#
# FORMATO:
# - Usa listas cuando recomiendes canciones.
# - Respuestas cortas y directas — no repitas el análisis de la pregunta anterior.
...
#             text-align: left;
#         }
#         .example-pill:hover { background: #3a3a6a; }
#
#         /* ── MAIN ── */
#         .main {
#             margin-left: 240px;
...
#             word-wrap: break-word;
#         }
#         /* estilos para el markdown DENTRO de la burbuja bot */
#         .bot-msg p  { margin: 0 0 6px 0; }
#         .bot-msg p:last-child { margin-bottom: 0; }
#         .bot-msg strong { font-weight: 700; color: #3730a3; }
#         .bot-msg ul, .bot-msg ol { margin: 4px 0 6px 16px; padding: 0; }
#         .bot-msg li { margin-bottom: 2px; }
#         .bot-msg code {
#             background: #eeeeff;
#             border-radius: 4px;
#             padding: 1px 5px;
...
#         <script>
#         /* Enviar con Enter ── se ejecuta DESPUÉS de que Dash monta el DOM */
...
#
# app.layout = html.Div([
#     # historial serializable guardado en el navegador — evita duplicados con debug=True
#     dcc.Store(id="chat-store", data=[]),
#
#     # ── SIDEBAR ──
#     html.Div([
#         html.H2("🎵 CorpusBeat IA"),
#         html.P(
#             "Escribe libremente. El bot detecta automáticamente si quieres "
#             "chat, análisis de sentimiento, resumen o traducción.",
#             className="sidebar-desc",
#         ),
#         html.Div("Ejemplos rápidos", className="sidebar-section"),
#         html.Button("💬 ¿Qué canciones hablan de amor?",         id="ex1", className="example-pill"),
#         html.Button("📊 Analiza el sentimiento de 3 canciones",  id="ex2", className="example-pill"),
#         html.Button("📝 Haz un resumen de 3 canciones",          id="ex3", className="example-pill"),
#         html.Button("🌍 Traduce 3 canciones aleatorias",         id="ex4", className="example-pill"),
#         html.Button("🎶 Recomiéndame canciones de desamor",      id="ex5", className="example-pill"),
#     ], className="sidebar"),
#
#     # ── MAIN ──
#     html.Div([
#         # métricas
#         html.Div([
#             html.Div("🎧 12,273 canciones indexadas", className="card"),
#             html.Div("⚡ RAG + FAISS",                 className="card"),
#             html.Div("🧠 BERT + OpenAI",               className="card"),
#         ], className="metrics"),
#
#         html.Div("💬 Chat Inteligente", className="chat-title"),
#
#         # caja de chat
#         html.Div(id="chat_box", className="chat-box"),
#
#         # input
#         html.Div([
#             dcc.Input(
...
# )
# def fill_example(e1, e2, e3, e4, e5):
#     ejemplos = {
#         "ex1": "¿Qué canciones hablan de amor?",
#         "ex2": "Analiza el sentimiento de 3 canciones",
#         "ex3": "Haz un resumen de 3 canciones",
#         "ex4": "Traduce 3 canciones aleatorias",
#         "ex5": "Recomiéndame canciones de desamor",
#     }
